...
import { CategoryProbioticsService } from './category-probiotics.service';


describe('CategoryProbiotics Service', () => {
  let service: CategoryProbioticsService;
  let httpMock: HttpTestingController;
  let elemDefault: ICategoryProbiotics;
  let expectedResult: ICategoryProbiotics | ICategoryProbiotics[] | boolean | null;
  ...
  it('should return a list of CategoryProbiotics', () => {
    const returnedFromService = Object.assign(
      {
        id: 1,
