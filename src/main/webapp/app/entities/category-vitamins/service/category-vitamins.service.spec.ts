...
import { CategoryVitaminsService } from './category-vitamins.service';


describe('CategoryVitamins Service', () => {
  let service: CategoryVitaminsService;
  let httpMock: HttpTestingController;
  let elemDefault: ICategoryVitamins;
  let expectedResult: ICategoryVitamins | ICategoryVitamins[] | boolean | null;
  ...
  describe('Service methods', () => {
    ...
    it('should return a list of CategoryVitamins', () => {
      const returnedFromService = Object.assign(
        {
          id: 1,
